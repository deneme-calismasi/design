...
regs = [16842, 33602, 16844, 13904, 16848, 36187, 16847, 4206, 16846, 15114, 16842, 12657]
...
start_regs = len(resultList)

time_data = dt.datetime.now().strftime('%Y-%m-%d %X')

start = 1
start_range = start_regs

value = [[num for num in range(start, start + start_range)], sensorNo, resultList]
