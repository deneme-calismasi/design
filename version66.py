...
for record in res[-(start_regs // 2):]:
    ...
    for x in range(26):
        if float(record[1]) > 30.0:
            ...
            start2 = 40
            for v in range(26):
                shape5 = canvas.create_rectangle(start2, 500, start2 + 10, 520, fill='red', outline='white',
                                                 stipple='gray50')
                start2 += 60

            start3 = 190
            for y in range(8):
                shape6 = canvas.create_rectangle(365, start3, 385, start3 + 10, fill='red', outline='white',
                                                 stipple='gray50')
                start3 += 40
            ...
            start2 = 40
            for v in range(26):
                shape5 = canvas.create_rectangle(start2, 500, start2 + 10, 520, fill='blue', outline='white',
                                                 stipple='gray50')
                start2 += 60

            start3 = 190
            for y in range(8):
                shape6 = canvas.create_rectangle(365, start3, 385, start3 + 10, fill='blue', outline='white',
                                                 stipple='gray50')
                start3 += 40
