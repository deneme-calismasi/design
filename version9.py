...
data = [
    ...
    [16, get_random_string(3), round(get_random_number(), 2)],
    [17, get_random_string(3), round(get_random_number(), 2)],
    [18, get_random_string(3), round(get_random_number(), 2)],
    [19, get_random_string(3), round(get_random_number(), 2)],
    [20, get_random_string(3), round(get_random_number(), 2)],
    [21, get_random_string(3), round(get_random_number(), 2)],
    [22, get_random_string(3), round(get_random_number(), 2)],
]
...
data1 = {'Machine': [data[0][1], data[1][1], data[2][1], data[3][1], data[4][1], data[5][1], data[6][1], data[7][1],
                     ...
                     data[15][1], data[16][1], data[17][1], data[18][1], data[19][1], data[20][1], data[21][1]],
         'Temperature': [data[0][2], data[1][2], data[2][2], data[3][2], data[4][2], data[5][2], data[6][2], data[7][2],
                         ...
                         data[15][2], data[16][2], data[17][2], data[18][2], data[19][2], data[20][2], data[21][2]]
         }
